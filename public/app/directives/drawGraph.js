        ...
        function d3Draw(scope, element, attr, ctrl) {
            ...
            scope.$watchGroup(['d3Links', 'd3Nodes', 'searchedNode'], function (newValues) {
                ...
                d3.select(element[0]).append('div')
                    ...
                    .style('left', '0')
                    .style('top', '5px')
                    .html('<p><span>Person : </span><i class="fa fa-user" style="color: #777" aria-hidden="true"></i></p>' +
                        '<p><span>Technology : </span><i style="color : #777" class="fa fa-circle" aria-hidden="true"></i></p>')
                ;
                myChart
